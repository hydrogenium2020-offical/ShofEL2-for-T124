...
#define INTERMEZZO_REL_ADD ( BOOTROM_PAYLOAD_ENTRY - INTERMEZZO_LEN )

#define OFFSET_INTERMEZZO_START     0x0
#define OFFSET_PAYLOAD_START        ( INTERMEZZO_LEN )
#define OFFSET_MEMCPY_RET_ADD       ( BOOTROM_SMASH_LEN - 0x30C - 0x4 ) // 0x30CB copied from the stack before entry
...
#define MAX_PAYLOAD_BEF_SIZE        ( OFFSET_PAYLOAD_THUMB_MODE - OFFSET_PAYLOAD_START )
#define MAX_PAYLOAD_AFT_SIZE        ( IRAM_END - OFFSET_PAYLOAD_CONT - VARS_LEN - 0x4 ) // Minus 0x14 to avoid finish RCM CMD
#define MAX_PAYLOAD_FILE_SIZE       ( MAX_PAYLOAD_BEF_SIZE + MAX_PAYLOAD_AFT_SIZE )
